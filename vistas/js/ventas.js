...
function agregarImpuesto(){
	...
	$("#restante").val(totalConImpuesto - anticipo);

	$(".restante").number(true, 2);

	// console.log(laser_corte);
...
function validarChecks(){
	...
	if($("#terminado").is(':checked'))			{$("#acabado").val(2)}
	// LASER
	if($(".laser_corte_").prop("checked"))   	{$("#laser_corte").val(1)}else{$("#laser_corte").val(0)}
	if($(".laser_grabado_").prop("checked")) 	{$("#laser_grabado").val(1)}else{$("#laser_grabado").val(0)}
	// PLASMA
	if($(".plasma").prop("checked")) 			{$("#plasma_corte").val(1)}else{$("#plasma_corte").val(0)}
	// ROUTER
	if($(".router_corte_").prop("checked")) 	{$("#router_corte").val(1)}else{$("#router_corte").val(0)}
	...
	//SERVICIO O PRODUCTO
	if($(".serv_prod_").prop("checked")) 		{$("#serv_prod").val(1)}else{$("#serv_prod").val(0)}
...
$("#nuevoMetodoPago").change(function(){
	...
	if(metodo == "Efectivo"){
		...
		$(this).parent().parent().parent().children(".cajasMetodoPago").html(
			 ...
			 '<div class="col-xs-4">'+ 
			 	...
			 	'<div class="input-group">'+ 
			 		...
			 		'<input type="text" class="form-control" id="nuevoValorEfectivo" placeholder="Recibo" required>'+
		...
		$(this).parent().parent().parent().children(".cajasMetodoPago").html(
			 ...
			 '<div class="col-xs-4">'+ 
			 	...
			 	'<div class="input-group">'+ 
			 		...
			 		'<input type="text" class="form-control" id="linea" placeholder="Linea" readonly >'+
			 ...
			 '<div class="col-xs-4" id="capturarCambioEfectivo" style="padding-left:0px">'+
			 	...
			 	'<div class="input-group">'+
			 		...
			 		'<input type="text" class="form-control" id="credit_" placeholder="disponible" readonly >'+
		...
		// TRAER VALOR DESDE LA BASE DE DATOS
	    ...
	    $.ajax({
	      ...
	      dataType:"json",
	      	success:function(respuesta)
	      	{	      
	      		saldo = (respuesta["credito"]) - (respuesta["adeudo"]);
	      		$("#linea").val(respuesta["credito"]);
	      		$("#credit_").val(saldo);
	      		//alert(saldo);
	  		}
	  	})
